# ColabTurtle Tutorial: 13-Week Complete Course
...
2. **Install ColabTurtle**: Run `!pip install ColabTurtle` in a code cell
3. **Start with Week 1**: Open [01-introduction-and-setup.md](01-introduction-and-setup.md)
4. **Follow along**: Copy code examples and experiment!
5. **Complete exercises**: Practice with the exercises in each tutorial
6. **Build projects**: Create the challenge projects to reinforce learning
...
### Week 1: [Introduction & Setup](01-introduction-and-setup.md)
...
### Week 2: [Basic Shapes & Loops](02-basic-shapes-and-loops.md)
...
### Week 3: [Colors & Pen Control](03-colors-and-pen-control.md)
...
### Week 4: [Functions & Modularity](04-functions-and-modularity.md)
...
### Week 5: [Patterns & Loops](05-patterns-and-loops.md)
...
### Week 6: [Positioning & Navigation](06-positioning-and-navigation.md)
...
### Week 7: [Advanced Shapes & Curves](07-advanced-shapes-and-curves.md)
...
### Week 8: [Recursion & Fractals](08-recursion-and-fractals.md)
...
### Week 9: [Animation Basics](09-animation-basics.md)
...
### Week 10: [Mathematical Art](10-mathematical-art.md)
...
### Week 11: [Interactive Patterns](11-interactive-patterns.md)
...
### Week 12: [Complex Projects](12-complex-projects.md)
...
### Week 13: [Final Project & Portfolio](13-final-project-and-portfolio.md)
...
2. **Experiment freely** - Change values, try different colors, break things!
3. **Complete the exercises** - They reinforce what you've learned.
4. **Build the projects** - Projects integrate multiple concepts.
5. **Debug your errors** - Mistakes are learning opportunities.
6. **Share your work** - Show others what you create!
